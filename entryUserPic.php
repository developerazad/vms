							...
							<div class="form-group">
						        ...
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           	<input name="pic" placeholder="Photo" class="form-control" type="file" required="required">
						           </div>
						        </div>
     						 </div>
     						 <div class="form-group">
						...
						if (isset($_POST["submit"])) {
							...
							// checking username exist or not 
								...
								// checking username exist or not End
									...
									$sql = "INSERT INTO user (pic,username, password,role) VALUES('". basename($_FILES["pic"]["name"])."','".$_POST["username"]."', sha1('" .$_POST["password"]."'),'".$_POST["role"]."')";
