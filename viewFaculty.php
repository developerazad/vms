 <?php include("header.php"); ?>
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Faculties Of HSTU</h3>
					...
					<!-- Selecting from database -->
						...
						?>
													...
													<td><a href="updateFaculty.php?f_id=<?php echo $row['f_id']?>">Update</a></td>
													<td><a href="deleteFaculty.php?f_id=<?php echo $row['f_id']?>">Delete</a></td>
						...
						<div class="form-group">
						        ...
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <a href="entryFaculty.php"><input name="addnew" class="form-control" type="button" value="Add New" style="width:110px;"></a>
						           </div>
						        </div>
     					</div>
     					<div class="form-group">
